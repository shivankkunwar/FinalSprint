        ...
        <div className="flex items-center mb-4">
          ...
          <Breadcrumb>
            <BreadcrumbList className="px-2 text-gray-300 ">
              ...
              <BreadcrumbSeparator/>
              <BreadcrumbItem>
                <BreadcrumbLink href="/problems" className="hover:text-white">Problems</BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator/>
              <BreadcrumbItem>
                <BreadcrumbPage className="text-gray-200" >Carousel Component</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
